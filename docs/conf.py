...
release = version = open_notebook.__version__
...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/open-notebook",
...
htmlhelp_basename = "open_notebookdoc"
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(open_notebook.__file__).parent)
    # fmt: on

    return f"https://github.com/{github_username}/open-notebook/blob/{html_context['github_version']}/src/open_notebook/{fn}{linespec}"
